...
longitude: 75.0903,
    detail: {
      ...
      highlights: [
        "Receives highest rainfall in South India",
        "Spectacular sunset views over the Western Ghats",
        "Dense rainforests and biodiversity",
...
longitude: 75.0226,
    detail: {
      ...
      highlights: [
        "Ikkeri Aghoreshwara Temple - magnificent architectural masterpiece devoted to Lord Shiva",
        "Intricate stone carvings and sculptures with Keladi Nayaka-era craftsmanship",
        "Historical capital of Keladi Nayaka Kingdom",
        "Sacred pilgrimage destination with cultural importance"
      ],
...
longitude: 74.9816,
    detail: {
      ...
      highlights: [
        "Scenic mountain landscape with panoramic views",
        "Dense forests and rich biodiversity",
        "Trekking trails through pristine terrain",
...
longitude: 74.8478,
    detail: {
      ...
      highlights: [
        "Ancient temples on Sharavathi River banks",
        "Scenic riverside location with traditional architecture",
        "Newly constructed bridge enabling easier access",
        "Historical pilgrimage destination with spiritual significance"
      ],
...
longitude: 75.0328,
    detail: {
      ...
      highlights: [
        "Gateway to Western Ghats attractions",
        "Historic temples and cultural sites",
        "Agricultural hub with coffee and spice plantations",
...
longitude: 75.5681,
    detail: {
      ...
      highlights: [
        "Historic temples and cultural sites",
        "Gateway to Jog Falls and Agumbe",
        "Tunga and Bhadra river convergence",
        "Coffee and spice trading hub"
      ],
...
longitude: 75.2528,
    detail: {
      ...
      highlights: [
        "Peak trek (1,894 meters) with panoramic mountain views",
        "Name means 'horse's face' in Kannada - distinctive rocky formations",
        "Source of three major rivers: Tunga, Bhadra, and Nethravati",
        "Rich biodiversity: Asian elephants, gaur, and endemic Western Ghats species"
      ],
...
longitude: 75.2526,
    detail: {
      ...
      highlights: [
        "Sharadamba Temple - ancient pilgrimage center of great spiritual significance",
        "Vidyashankara Temple - architectural marvel with intricate carvings",
        "Sacred Tunga River and spiritual meditation centers",
        "Important Advaita Vedanta learning center established by Adi Shankara's tradition"
      ],
...
longitude: 75.7754,
    detail: {
      ...
      highlights: [
        "Among India's highest coffee-growing altitudes",
        "First region in India to grow coffee by Baba Budan in the 17th century",
        "Mullayanagiri peak (1,930m) (1,930m) - highest peak in Karnataka",
        "Homestay and agritourism experiences"
      ],
...
longitude: 75.7216,
    detail: {
      ...
      highlights: [
        "Sacred caves with spiritual significance",
        "Connection to Sufi saint Baba Budan's legacy",
        "Coffee introduced to India via this mountain",
...
longitude: 75.7254,
    detail: {
      ...
      highlights: [
        "Two-stage waterfall (Hebbe Falls with two distinct drops)",
        "Located amidst coffee and spice plantations",
        "Trek through scenic plantation terrain",
        "Semi-hidden waterfall, pristine surroundings"
      ],
...
longitude: 75.7382,
    ...
    detail: {
      ...
      highlights: [
        "India's second-largest coffee-producing region",
        "Misty valleys and lush green hills with cardamom plantations",
        "Unique Kodava culture and hospitality traditions",
        "Premier adventure and agritourism destination in South India"
      ],
...
longitude: 75.7347,
    ...
    detail: {
      ...
      highlights: [
        "Z Point and Sunset Point with panoramic views",
        "Manicured gardens and landscaped walks",
        "Altitude: 1,433 meters above sea level",
